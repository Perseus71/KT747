...
export INITRAMFS_SOURCE=`readlink -f ..`/Ramdisks/AOSP_JB_4.4
export CONFIG_AOSP_BUILD=y
export PACKAGEDIR=$PARENT_DIR/Packages/AOSP_KK_D2LTE
#Enable FIPS mode
...
# make KT747_d2packageatt_defconfig
...
if [ -e $KERNELDIR/arch/arm/boot/zImage ]; then
	...
	rm ramdisk.gz
	rm zImage
	rm ../KT747-AOSP-KK-D2LTE*.zip
	zip -r ../KT747-AOSP-KK-D2LTE-$curdate.zip .
	cd $KERNELDIR
else
